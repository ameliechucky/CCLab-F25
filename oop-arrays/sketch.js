...
class Cloud {
  ...
  constructor(x, y, s) {
    ...
    this.y0 = y;
    this.s = s;
    this.speedX = map(this.s, 30, 100, 2, 0.2);
    this.speedY = map(this.s, 30, 100, 0.05, 0.005);
    this.h = random(100);
  }
  ...
  move() {
    ...
    let amp = map(this.s, 30, 100, 50, 10);
    this.y = this.y0 + amp * sin(frameCount * this.speedY);
